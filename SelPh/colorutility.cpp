...
{
    const double x = XYZ(0) / referenceXYZ(0);
    const double y = XYZ(1) / referenceXYZ(1);
    const double z = XYZ(2) / referenceXYZ(2);

    auto f_XYZ2Lab = [] (double r) -> double
    {
