...
public:
    ...
    void    computeWeightsWithReduction(double threshold = 0.01, int maximum = 1000);
...
private:
    ...
    // for multi-thread
    void calculateSumOfRBFValues(const std::vector<double>& x, int start, int end, double* result);
};
